...
Now, if we want to pull the commit e43a6 into our master branch we can use ``` git cherry-pick e43a6... ``` , which pulls the same change introduced in e43a6, but we get a new commit SHA-1 value. 
